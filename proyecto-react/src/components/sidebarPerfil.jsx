        ...
        <div className="flex flex-no-wrap h-screen">
            ...
            <div className="w-64 absolute sm:relative bg-slate-900 shadow lg:h-full flex-col justify-between hidden sm:flex">
                <div>
                    <div className="flex items-center px-8 py-4">
                        <img className="rounded-full" src="https://media-exp1.licdn.com/dms/image/C5603AQEUYbA5Fo-blQ/profile-displayphoto-shrink_800_800/0/1618197473111?e=1647475200&v=beta&t=cleKA-fHE_dOYHgGi98bZh51fZvb8QvksEB5spKPbiU" width={200} height={200}/>
                    </div>
            ...
            <div className="text-gray-600 mr-8 visible sm:hidden relative" onclick="dropdownHandler(this)">
                <ul className="p-y w-64 border-r bg-indigo-900 absolute rounded left-0 shadow mt-8 sm:mt-16 hidden">
                    <li className="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-15 px-2">
                        <div className="flex items-center">
